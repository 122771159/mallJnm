...
public interface OrderVOMapper {
    ...
    @Select("""
            ...
            <where>
                ...
                <if test="ew.userType == 'SUPER' and ew.customerId != null and ew.customerId != ''">
                 ...
                 <if test="ew.userType == 'ADMIN' and ew.customerId != null and ew.customerId != ''">
                     AND o.customer_id = #{ew.customerId}
                </if>
    ...
    /**
     * 新增：用于导出订单，查询所有符合条件的记录，不进行分页
     * @param params 查询参数，与分页查询一致
     * @return 订单列表
     */
    @Select("""
            <script>
            ...
            """)
    List<OrderListVO> listAllOrdersForExport(@Param("ew") Map<String, Object> params);
